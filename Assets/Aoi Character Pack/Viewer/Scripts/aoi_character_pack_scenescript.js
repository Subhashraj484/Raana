...
var guiSkin              : GUISkin;
var viewCam              : aoi_character_pack_viewscript;
...
var facialMatName             : String = "f02_face_00";

private var guiShowFlg           : boolean = false;
private var viewerResourcesPath  : String = "Aoi";
...
function Start () {
	...
	viewCam = GameObject.Find("Main Camera").GetComponent("aoi_character_pack_viewscript");
